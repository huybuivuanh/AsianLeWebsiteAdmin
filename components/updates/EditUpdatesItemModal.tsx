...
export function EditUpdatesItemModal({
  open,
  item,
  onClose,
  onSave,
}: EditUpdatesItemModalProps) {
  ...
  return (
    <div
      ...
      aria-modal="true"
      role="dialog"
      aria-labelledby="edit-updates-item-title"
    >
      <div
      ...
      <div className="relative w-full max-w-md rounded-xl bg-background border border-foreground/10 shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label
              htmlFor="edit-updates-display-name"
              className="block text-sm font-medium text-foreground mb-1"
            >
              Display Name <span className="text-red-500">*</span>
            </label>
            <input
              id="edit-updates-display-name"
              type="text"
              value={displayName}
