...
type AddDemoCategoryItemsModalProps = {
  open: boolean;
...
export function AddDemoCategoryItemsModal({
  open,
  category,
  onClose,
  onSave,
}: AddDemoCategoryItemsModalProps) {
  ...
  return (
    <div
      ...
      aria-modal="true"
      role="dialog"
      aria-labelledby="add-demo-category-items-title"
    >
      <div
      ...
      <div className="relative w-full max-w-3xl max-h-[85dvh] flex flex-col rounded-2xl bg-background border border-foreground/10 shadow-xl">
        <div className="px-6 py-4 border-b border-foreground/10 flex items-center justify-between gap-4 shrink-0">
          <h2
            id="add-demo-category-items-title"
