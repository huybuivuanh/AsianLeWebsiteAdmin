...
type EditDemoCategoryModalProps = {
  open: boolean;
...
export function EditDemoCategoryModal({
  open,
  category,
  onClose,
  onSave,
}: EditDemoCategoryModalProps) {
  ...
  return (
    <div
      ...
      aria-modal="true"
      role="dialog"
      aria-labelledby="edit-demo-category-title"
    >
      <div
      ...
      <div className="relative w-full max-w-md rounded-xl bg-background border border-foreground/10 shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label
              htmlFor="edit-demo-category-name"
              className="block text-sm font-medium text-foreground mb-1"
            >
              Name <span className="text-red-500">*</span>
            </label>
            <input
              id="edit-demo-category-name"
              type="text"
              value={name}
          ...
          <div>
            <label
              htmlFor="edit-demo-category-description"
              className="block text-sm font-medium text-foreground mb-1"
            >
              Description
            </label>
            <textarea
              id="edit-demo-category-description"
              value={description}
